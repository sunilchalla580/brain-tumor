...
class Preprocessing(object):
    ...
    def getInfectedRegion(self):
        ...
        cv2.imwrite("F:\\intern\\braintumor\\tmp\\no_noise.jpg", self.no_noise)

        # tumourImage
        self.tumourImage = self.no_noise[col1:col2, row1:row2]
        cv2.imwrite("F:\\intern\\braintumor\\tmp\\tumourImage.jpg", self.tumourImage)
...
preprocessing.preproces('F:\\intern\\braintumor\\FLAIR\\img6.jpg')
